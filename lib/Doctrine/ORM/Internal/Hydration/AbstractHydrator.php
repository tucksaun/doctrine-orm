...
abstract class AbstractHydrator
{
    ...
    /**
     * @param mixed[] $data SQL Result Row.
     * @psalm-param array<array-key, string> $id                 Dql-Alias => ID-Hash.
     * @psalm-param array<array-key, bool>   $nonemptyComponents Does this DQL-Alias has at least one non NULL value?
     *
    ...
    /**
     * @param mixed[] $data SQL Result Row.
     * @psalm-param string $dqlAlias                 Dql-Alias
     *
     * @psalm-return array<array-key, array> An array with all the fields
     *                                             (name => value) of the data
     *                                             row, grouped by their
     *                                             component alias.
     */
    protected function gatherRowDataFromDQLMapping(array $data, string $dqlAlias)
    {
        $rowData = [];
